...
import ConfirmPasswordDialog from "@calcom/ee/teams/components/ConfirmPasswordDialog";
  ...
  return (
    <>
      <li className="">
        ...
        <div
          className={classNames("flex items-center  justify-between", !isInvitee && "hover:bg-muted group")}>
          {!isInvitee ? (
            <Link
      ...
      <ConfirmPasswordDialog
        ...
        setConfirmPasswordOpen={setConfirmPasswordOpen}
        onConfirmPasswordSuccess={() => acceptOrLeave(true)}
      />
    </>
  );
}
